      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="space-y-8">
            {(Array.isArray(t("experience.projects"))
              ...
              >
                ...
                <div className="p-6 rounded-lg border-l-4 border-purple-500 bg-gray-700/50 hover:shadow-lg transition-shadow">
                  <div className="flex items-start gap-4">
                    <Briefcase className="text-purple-500 mt-1 shrink-0" />
